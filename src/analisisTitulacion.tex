...
\autor[Grupo 2CV16]{Análisis y diseño orientado a objetos}
\sistema[AdminFarmacia]{Prueba}
\proyecto[PruebaProyecto]{Proyecto Final}
\documento{DocLaTeX}{Proyecto para Análisis y diseño orientado a objetos}{\RELEASE{1.0}}% {\DRAFT{\today}} 
