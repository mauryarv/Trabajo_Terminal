\begin{UseCase}{CU 1.5.5}{Descontinuar Producto del Inventario} {
	
	Descontinuar un producto del Inventario haciendo clic en el ícono de menos de un producto en la parte de ajustes.
}
...
\UCsection{Atributos}
	...
	\UCitem{Propósito}{
		Descontinuar de un producto del Inventario desde la interfaz de Inventario.
	}
	\UCitem{Entradas}{
		Ninguna.
	}
	...
	\UCitem{Postcondiciones}{
		Puede cancelar la descontinuacióon del producto.
	}
